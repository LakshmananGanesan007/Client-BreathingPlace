...
export default function ResetPassword() {
  ...
  // Supabase injects the session via the URL hash automatically on page load
  ...
  if (done) {
    return (
      <AuthLayout icon={Lock} title="Password updated" subtitle="Your password has been changed successfully">
