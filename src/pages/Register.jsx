...
export default function Register() {
    ...
    return (
      <AuthLayout icon={Mail} title="Check your email" subtitle={`We sent a confirmation link to ${email}`}>
        <p className="text-sm text-muted-foreground text-center">
          Click the link in your email to confirm your account, then{" "}
          <Link to="/login" className="text-primary font-medium hover:underline">log in</Link>.
        </p>
        <p className="text-xs text-center text-muted-foreground mt-2">
          After logging in, you'll choose your path and set up your profile.
        </p>
      </AuthLayout>
    );
  }
  ...
  return (
    <AuthLayout
      ...
      subtitle="Sign up to get started on BreathingPlace"
      footer={
        <>
